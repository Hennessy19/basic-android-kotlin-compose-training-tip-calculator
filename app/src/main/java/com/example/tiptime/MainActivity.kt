...
fun TipTimeLayout() {
    ...
    Column(
        modifier = Modifier
            ...
            .safeDrawingPadding()
            .verticalScroll(rememberScrollState()),// for auto rotate of the screen
...
@Composable
fun EditNumberField(
    @StringRes label: Int, // marks that this will be a string resource
    ...
    TextField(
        ...
        singleLine = true, //condenses the textbox to a single scrollable line
        keyboardOptions = keyboardOptions,
        modifier = modifier
    )
}
